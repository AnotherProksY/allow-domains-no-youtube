...
ExcludeServices = {"cloudflare.lst", "google_ai.lst", "google_play.lst", 'hetzner.lst', 'ovh.lst', 'digitalocean.lst', 'cloudfront.lst', 'hodca.lst'}
...
def generate_srs_for_categories(directories, output_json_directory='JSON', compiled_output_directory='SRS'):
    ...
    exclude = {"meta", "twitter", "discord", "hetzner", "ovh", "digitalocean", "cloudfront"}
